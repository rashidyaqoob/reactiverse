                ...
                { LatestUpdateList.map((item) => {
                    return (
                        <Link className='latest-update-cards__item' to={item.url}>
                            <Image src={item.image} alt="latest-card-image" extraClasses="latest-update-cards__item-image"/>
                            <p className="latest-update-cards__item-title">{item.title}</p>
                            <p className="latest-update-cards__item-description">{item.description}</p>
                        </Link>
                    )
                })}
            </div>
